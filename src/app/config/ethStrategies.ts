...
export const ETH_CONFIG: Strategy[] = [
  {
    ...
    fixedValue: { value: 21.06, asset: "USD" }, // leveraged value of collateral, not just USDe
    points: [
      {
  ...
  },
  {
    ...
    fixedValue: { value: 21.1, asset: "USD" }, // leveraged value of collateral, not just USDe
    points: [
      {
        type: POINTS_ID_ETHENA_SATS_S4,
        expectedPointsPerDay: { value: 30, baseAsset: "USD" },
  ...
  },
  {
    ...
    fixedValue: { value: 25.03, asset: "USD" }, // leveraged value of collateral of LP, not just USDe
    points: [
      {
        type: POINTS_ID_ETHENA_SATS_S4,
        expectedPointsPerDay: { value: 30, baseAsset: "USD" },
  ...
  },
  {
    ...
    fixedValue: { value: 333.01, asset: "USD" }, // $5 of yts = 333.01 YTs x 50
    points: [
      {
        type: POINTS_ID_ETHENA_SATS_S4,
